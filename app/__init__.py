"""AgriNova AI - AI Agriculture Assistant

A Flask-based web application that provides AI-powered agricultural
advisory for Indian farmers using LLMs, speech recognition,
image analysis, and conversation memory.
"""
...
def create_app(config_object: Any = None) -> Flask:
    """Application factory for AgriNova AI.
...
def initialize_services(app: Flask) -> None:
    ...
    app.logger.info("AgriNova AI initialized successfully.")
